...
class DocumentOfficeStateController extends Controller
{
    /**
     ...
     * @return void
     */
    public function __construct(DocumentOfficeState $document_office_state, Document $document, Request $request)
    {
        //Instance
    ...
    public function store(Request $request){
        ...
        // //Integrity table
        // $exist =  $this->document_office_state
        ...
        //         ->where ('document_office_id',$data['document_office_id'])
        //         ->exists();
        ...
        // if(!$exist){
            try{
                ...
                'document_office_id' => $data['document_office_id'],
    ...
    public function show(Request $request,$id){
        //View
        $table_view='view_document_office_states';
        //Put paremeters headers in the array request
        $request['id'] = $id;
        // $request['office_id'] = $this->office_id;
        //Validate Data and Get dates request 
    ...
    //     //Validate Data and Get dates request 
    //     $data= $this->validate($request,[
    //         'id' => "required|integer|exists:$this->database.document_office_states,id",
    //         'document_office_id'=> "required|integer|exists:$this->database.document_offices,id",
    //     ]);
    //     //Validate if your office its the document own
    //     $permission =  $this->document
    ...
    public function destroy(Request $request,$id){
        ...
        //Get document_id
        $document_id=$this->document_office_state->findOrFail($request['id'])->document_id;
        //Validate if your office its the document own
        $permission =  $this->document
        ...
        //Query
        try{
            $results = $this->document_office_state->findOrFail($id);
            $results->delete();
            //Response
